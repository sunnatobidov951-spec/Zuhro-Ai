...
type ProductRepository interface {
	...
	// MARKETPLACE SEARCH
	// =========================
	List(ctx context.Context, params PaginationParams) ([]*domain.Product, int64, error)
	Search(ctx context.Context, query string, params PaginationParams) ([]*domain.Product, int64, error)
	AdvancedSearch(ctx context.Context, filter domain.ProductFilter, params PaginationParams) ([]*domain.Product, int64, error)
	...
	// SELLER SYSTEM
	// =========================
	GetBySellerID(ctx context.Context, sellerID uuid.UUID, params PaginationParams) ([]*domain.Product, int64, error)

	// =========================
	// CATEGORY
	// =========================
	GetByCategory(ctx context.Context, categoryID uuid.UUID, params PaginationParams) ([]*domain.Product, int64, error)
	...
	IncrementSales(ctx context.Context, productID uuid.UUID, count int) error
